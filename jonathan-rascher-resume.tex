...
\begin{document}
  ...
  \begin{topic}
    ...
    Grade-point average: 4.0\fracslash 4.0 after 123.5 credit hours.
  ...
  \begin{topic}
    ...
    \item[Fall 2008--Fall 2011] Dean\kern-0.05333em'\kern-0.054em s List (North Central College).

    \item[Fall 2007--Fall 2008] Dean\kern-0.05333em'\kern-0.054em s List (Elgin Community College).
  ...
  \begin{topic}
    ...
    \item[Jan.\ 2011--March 2011] \job{Preceptor: Computer Science II}{North Central College}.
    \item[June 2010--Sept.\ 2010] \job{Co\nbds op developer in DIS division}{Argonne National Laboratory}.
    \item[March 2010--June 2010] \job{Preceptor: Animation with Flash}{North Central College}.
    \item[Sept.\ 2009--March 2010] \hspace{-0.03425em}\job{Web application developer}{North Central College}.
