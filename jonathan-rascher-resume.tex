...
\setmainfont[BoldFont={* Bold},
             ...
             Kerning=Off,
             Ligatures=TeX]{Vollkorn}
\setsansfont[Ligatures=TeX]{Fertigo Pro}
...
\renewcommand{\topicmargin}{0.32\columnwidth}
...
\begin{document}
  ...
  \begin{topic}
    \item[Academic Yr.\ 2009--2010] Entrant in William Lowell Putnam Mathematical Competition.
