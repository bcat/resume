...
\begin{document}
  ...
  \begin{topic}
    ...
    \item Graduated June 2012 with a 4.0\fracslash 4.0 grade-point average.
  ...
  \begin{topic}
    \item[June 2012--present] \job{Software engineer}{Google}.
    ...
    \item[Summer 2007, 2008] \job{Food runner/Cashier}{Kane Country Cougars}.
